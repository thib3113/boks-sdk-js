...
async function verifyIIFE(filePath, globalVar, expectedExports) {
    ...
    try {
        ...
        const scriptFunc = new Function(...Object.keys(sandbox), code + `\nreturn typeof ${globalVar} !== 'undefined' ? ${globalVar} : undefined;`);
...
async function runAllChecks() {
    ...
    const sdkExports = ['BoksClient', 'BoksProtocolError', 'BoksClientError', 'BoksController', 'WebBluetoothTransport', 'BoksPacketFactory'];
