...
describe('BoksPacketFactory', () => {
  describe('createFromPayload with it.each', () => {
    ...
    const testCases = [
      ...
      { name: 'GenerateCodesPacket', class: Packets.GenerateCodesPacket, payload: new Uint8Array(32).fill(0) },
      { name: 'CreateMasterCodePacket', class: Packets.CreateMasterCodePacket, payload: new Uint8Array([...configKeyBytes, ...pinBytes, 0]) },
      ...
      { name: 'GenerateCodesSupportPacket', class: Packets.GenerateCodesSupportPacket, payload: new Uint8Array(32).fill(0) },
      ...
      { name: 'NfcRegisterPacket', class: Packets.NfcRegisterPacket, payload: new Uint8Array([...configKeyBytes, 4, 1, 2, 3, 4]) },
      { name: 'UnregisterNfcTagPacket', class: Packets.UnregisterNfcTagPacket, payload: new Uint8Array([...configKeyBytes, 4, 1, 2, 3, 4]) },
