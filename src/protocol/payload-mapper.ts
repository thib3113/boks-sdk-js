...
export class PayloadMapper {
  ...
  public static parse<T>(targetClass: { new (...args: any[]): T } | Function, payload: Uint8Array): Partial<T> {
    ...
    return parser(payload, BoksProtocolError, BoksProtocolErrorId, this.HEX_TABLE) as Partial<T>;
  }
...
/**
 * Decorator to map a fixed-length ASCII string field (e.g., PIN, Config Key).
 */
