...
## 2024-03-22 - Core **Hardened:** src/protocol/uplink/UnknownPacket.ts **Edge-Cases Covered:** Arbitrary random payload fuzzing for opcodes and buffers, proper error on `fromPayload` misuse.