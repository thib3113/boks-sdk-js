...
On newer firmwares, the Boks may experience a Watchdog reset immediately after accepting the new key, causing it to only save the **second half** (the last 16 bytes) of your Master Key to non-volatile memory.

**Solution:** If this happens, try replacing the first 32 characters (16 hex bytes) of your new 64-character Master Key with zeros (e.g., `00000000000000000000000000000000<second_half>`). Your codes should then work correctly.
