...
// Fonction utilitaire pour déduire la source à partir de l'Opcode
function getOpenSourceLabel(opcode: BoksOpcode): string {
  switch (opcode) {
    case BoksOpcode.LOG_CODE_BLE_VALID: return 'Application Mobile (Bluetooth)';
    case BoksOpcode.LOG_CODE_KEY_VALID: return 'Code Clavier';
    case BoksOpcode.LOG_EVENT_NFC_OPENING: return 'Tag NFC';
    case BoksOpcode.LOG_EVENT_KEY_OPENING: return 'Clé Physique de Secours';
