export const i18n = {
  en: {
    ...
    nfc: {
      ...
      scanDesc: 'Put the Boks into scanning mode and tap an NFC tag within 6 seconds.',
      scanBtn: 'Start Scan (6s)',
    ...
    nfc: {
      ...
      scanDesc: 'Mettez la Boks en mode scan et approchez un tag NFC dans les 6 secondes.',
      scanBtn: 'Démarrer le Scan (6s)',
