export const i18n = {
  en: {
    ...
    provision: {
      ...
      confirmMultipleDownloads: 'During this process, multiple files will be downloaded (your new recovery key and a log file). Please ensure your browser allows multiple downloads before proceeding. If prompted, please allow it.',
  ...
  fr: {
    ...
    provision: {
      ...
      confirmMultipleDownloads: 'Durant ce processus, plusieurs fichiers vont être téléchargés (votre nouvelle clé de récupération et un fichier journal). Veuillez vous assurer que votre navigateur autorise les téléchargements multiples. Si une popup apparait, veuillez l\'accepter.',
