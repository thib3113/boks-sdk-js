export const i18n = {
  en: {
    ...
    provision: {
      ...
      blockingTitle: 'DO NOT TOUCH KEYBOARD',
      blockingDesc: 'Keep this window focused and stay close to the Boks (1-2m). Background tasks have been suspended.',
  ...
  fr: {
    ...
    provision: {
      ...
      blockingTitle: 'NE TOUCHEZ PAS AU CLAVIER',
      blockingDesc: 'Gardez cette fenêtre au premier plan et restez près de la Boks (1-2m). Les tâches en arrière-plan ont été suspendues.',
